...
\backgroundsetup {
	scale=3,                % Scale of the background image (e.g., 3 times the normal size)
	color=gray,             % Color of the background (if using text or colors)
	opacity=0.2,            % Opacity of the background
	angle=45,               % Angle of rotation (in degrees)
	% position=current page.south, % Position of the background (e.g., south of the current page)
	vshift=1cm,             % Vertical shift of the background
	hshift=1cm,             % Horizontal shift of the background
	contents={\Huge\it Nguyenhuyen\_AG} % Text that appears in the background
}
