...
% We rewrite the inequality as là một đa thức của a
...
% or
%\[6a^2(b^2+c^2) - (5b^2+2bc+5c^2)a^2  +(b+c)(b^2+bc+c^2)a- \frac{3a(b^2+c^2)^2}{b+c}+(b^2+bc+c^2)(b-c)^2 \geqslant 0,\]
% \[[6a^2(b^2+c^2) - (5b^2+2bc+5c^2)a^2]  + \left[(b+c)(b^2+bc+c^2)a- \frac{3a(b^2+c^2)^2}{b+c}\right]+(b^2+bc+c^2)(b-c)^2 \geqslant 0,\]
\[\begin{aligned}
